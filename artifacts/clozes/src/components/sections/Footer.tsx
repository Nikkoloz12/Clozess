...
export function Footer() {
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
        ...
        <div className="max-w-sm">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            AI-powered fit intelligence for clothing brands. Reduce returns, increase confidence, grow revenue.
          </p>
          <a
        ...
        <div className="flex gap-16">
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li><a href="#demo" className="hover:text-foreground transition-colors">Size Finder</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li><a href="#business" className="hover:text-foreground transition-colors">For Brands</a></li>
              <li><a href="#waitlist" className="hover:text-foreground transition-colors">Early Access</a></li>
              <li><a href="mailto:hello@clozes.app" className="hover:text-foreground transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
  ...
  <div>&copy; {new Date().getFullYear()} Clozes. All rights reserved.</div>
